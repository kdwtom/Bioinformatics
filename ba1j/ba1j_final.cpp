...
void solve()
{
    ...
    for (int i = 0; i <= genomeSize - k; i++)
    {
        ...
        neighborAll.insert(neighborAll.end(), neighborsForward.begin(), neighborsForward.end());
        neighborAll.insert(neighborAll.end(), neighborsReverse.begin(), neighborsReverse.end());
    }
    int neighborLength = neighborAll.size();

    countArr.resize(neighborLength + 1);
    for (int i = 0; i < neighborLength; i++)
    {
        string pattern = neighborAll[i];
    ...
    for (int i = 0; i < neighborLength - 1; i++)
    {
